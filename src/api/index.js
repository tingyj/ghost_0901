...
// 2、获取食品分类列表
export const reqFoodTypes=function(){
    ajax('/index_category')
}
// 3、根据经纬度获取商铺列表
...
// 4、根据经纬度和关键字搜索商铺列表
export const reqSearchSop = ({geohash,keyword})=>{
...
// 6、用户名密码登陆
export const reqNameLogin= ({name,pwd,captcha})=>{
...
// 8、手机号验证码登陆
export const reqPhoneLog = ({phone,code})=>{
